    ...
    function handelView () {
        ...
        if (Config::load()) {
            switch (Request::getView()) {
                case self::view_offers:
                    OffersView::render();
                    break;
                case self::view_orders:
                    OrdersView::render();
                    break;
                case self::view_settings:
                    SettingsView::render();
                    break;
                case self::view_configurations:
                    ConfigurationsView::render();
                    break;
                case self::view_contactDetails:
                    ContectDetailsView::render();
                    break;
                case self::view_userOffers:
                    UserOffers::render();
                    break;
                case self::view_buyOffer:
                    BuyOfferView::render();
                    break;
                case self::view_deny:
                    DenyView::render();
                    break;
                case self::view_register:
                    RegisterView::render();
                    break;
