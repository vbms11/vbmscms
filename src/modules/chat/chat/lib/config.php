...
// Database hostname:
$config['dbConnection']['host'] = $GLOBALS['dbHost'];
// Database username:
$config['dbConnection']['user'] = $GLOBALS['dbUser'];
// Database password:
$config['dbConnection']['pass'] = $GLOBALS['dbPass'];
// Database name:
$config['dbConnection']['name'] = $GLOBALS['dbName'];
// Database type:
