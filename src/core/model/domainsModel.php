...
class DomainsModel {
    ...
    static function getDomainSite ($domain) {
        ...
        return Database::queryAsObject("select d.url, d.siteid, s.cmscustomerid, s.piwikid, s.sitetrackerscript, d.domaintrackerscript, s.facebookappid, s.facebooksecret, s.twitterkey, s.twittersecret
            from t_domain d 
